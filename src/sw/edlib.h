...
#define EDLIB_EDOP_MISMATCH 3 //!< Mismatch.
     ...
     */
    EDLIB_API void edlibFreeAlignResult(void* km, EdlibAlignResult result);
     ...
     */
    EDLIB_API EdlibAlignResult edlibAlign(void* km,
        const uint8_t* query, int queryLength,
        const uint8_t* target, int targetLength,
     ...
     */
    EDLIB_API char* edlibAlignmentToCigar(void* km,
